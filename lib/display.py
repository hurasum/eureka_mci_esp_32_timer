...
class TFT:
    ...
    def lineByAngle(self, x, y, start, length, angle, color):
        """
    ...
    def triangle(self, x, y, x1, y1, x2, y2, color, fillcolor):
        """
    ...
    def circle(self, x, y, r, color, fillcolor):
        """
    ...
    def ellipse(self, x, y, rx, ry, opt, color, fillcolor: Optional = None):
        """
        Draw the circle with center at (x,y) and radius r.
        If color is not given, current foreground color is used.
    ...
    def arc(self, x, y, r, thick, start, end,color, fillcolor):
        """
    ...
    def poly(self, x, y, r, sides, thick,color, fillcolor, rotate):
        """
    ...
    def rect(self, x, y, width, height,color, fillcolor):
        """
    ...
    def roundrect(self, x, y, width, height, r,color, fillcolor):
        """
    ...
    def font(self, font, rotate, transparent, fixedwidth, dist, width, outline, color):
        """
    ...
    def textClear(self, x, y, text,  color):
        """
